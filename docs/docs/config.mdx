...
| app:externalterminal                 | string   | macOS only. Sets which external terminal app is used by "Open Terminal Here". Supported values: `"terminal"` and `"ghostty"` (default = `"terminal"`)                                                                                                        |
